...
from evaluation.metrics import (
    sql_validity as _sql_validity,
    execution_accuracy as _execution_accuracy,
    answer_relevance as _answer_relevance,
    schema_recall as _schema_recall,
)

sql_validity     = track(project_name=OPIK_PROJECT_NAME)(_sql_validity)
execution_accuracy = track(project_name=OPIK_PROJECT_NAME)(_execution_accuracy)
answer_relevance = track(project_name=OPIK_PROJECT_NAME)(_answer_relevance)
schema_recall    = track(project_name=OPIK_PROJECT_NAME)(_schema_recall)
